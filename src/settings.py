...
ANNOTATION_TYPES: List[AnnotationType] = [AnnotationType.SemanticSegmentation(), AnnotationType.ObjectDetection()]

RELEASE_YEAR: int = 2020
HOMEPAGE_URL: str = "https://github.com/dataset-ninja/new-ninja"
# e.g. "https://some.com/dataset/homepage"

PREVIEW_IMAGE_ID: int = 5
# This should be filled AFTER uploading images to instance, just ID of any image.

GITHUB_URL: str = "https://github.com/dataset-ninja/new-ninja"
